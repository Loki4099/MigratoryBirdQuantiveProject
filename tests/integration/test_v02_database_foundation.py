...
def test_empty_database_migrates_to_one_clean_v02_head() -> None:
    ...
    assert status.current_revision == "20260804_25_v02_cohort"
    assert status.head_revisions == ("20260804_25_v02_cohort",)
...
def test_migration_can_downgrade_to_base_and_upgrade_again() -> None:
    ...
    assert upgraded.current_revision == "20260804_25_v02_cohort"
