...
def test_empty_database_migrates_to_one_clean_v02_head() -> None:
    ...
    assert status.current_revision == "20260802_03_v02_catalog"
    assert status.head_revisions == ("20260802_03_v02_catalog",)
...
def test_migration_can_downgrade_to_base_and_upgrade_again() -> None:
    ...
    assert upgraded.current_revision == "20260802_03_v02_catalog"
