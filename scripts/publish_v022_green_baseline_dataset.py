...
from style_rotation.v022.green_baseline_dataset_import import (
    GreenBaselineDatasetImportSpec,
    publish_green_baseline_dataset,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Publish one clean-green baseline Dataset")
    ...
    publication = publish_green_baseline_dataset(
