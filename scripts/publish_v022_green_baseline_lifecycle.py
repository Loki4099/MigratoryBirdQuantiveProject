...
from style_rotation.v022.green_baseline_lifecycle import (
    GreenBaselineLifecycleSpec,
    publish_green_baseline_lifecycle,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Publish clean-green lifecycle evidence")
    ...
    publication = publish_green_baseline_lifecycle(
